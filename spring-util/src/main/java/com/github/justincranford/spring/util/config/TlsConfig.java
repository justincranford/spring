...
public class TlsConfig {
    ...
    private record TlsAutoGeneratedConfig(
    ...
    @Bean
    @ConditionalOnProperty(value="server.ssl.auto-generate-certificates", havingValue="true")
    public TlsAutoGeneratedConfig tlsAutoGeneratedConfig() throws Exception {
	...
	public SSLContext clientSslContext(final TlsAutoGeneratedConfig tlsAutoGeneratedConfig) {
		try {
			final Certificate[] serverCertChain = tlsAutoGeneratedConfig.tlsServerChain().getCertificateChain();
